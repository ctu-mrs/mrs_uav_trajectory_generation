# MRS UAV Trajectory Generation [![Build Status](https://travis-ci.com/ctu-mrs/mrs_uav_trajectory_generation.svg?branch=master)](https://travis-ci.com/ctu-mrs/mrs_uav_trajectory_generation)

![](.fig/thumbnail.jpg)

## General description

This package provides a method for generation a time-parametrized [trajectory](https://ctu-mrs.github.io/mrs_msgs/srv/TrajectoryReference.html) out of a [path](https://ctu-mrs.github.io/mrs_msgs/msg/Path.html) (a sequence of waypoints).
