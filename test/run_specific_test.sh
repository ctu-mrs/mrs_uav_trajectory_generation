...
colcon test --packages-select mrs_uav_trajectory_generation --ctest-args -R 'fallback_sampling' --event-handlers console_direct+ console_stderr- console_start_end-
